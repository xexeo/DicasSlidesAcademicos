...
O slide da Figura \ref{fig:dados} é um exemplo típico de um slide monótono, mas algumas vezes usado em uma aula.
...
O uso de animação dentro do slide, porém, deve ser feito com muito cuidado.
