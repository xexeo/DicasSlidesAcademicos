...
Apresentações que seguem essas regras podem ser muito mais bonitas, e podem aproveitar de dezenas de truques de PowerPoint, por exemplo, mas não é sobre isso que esse texto trata.

Basicamente, é um texto sobre como organizar conteúdo para situações específicas, aulas, apresentações de dissertação e tese e provas de aula em concursos para professores, com foco na organização e expectativa de avaliadores.
